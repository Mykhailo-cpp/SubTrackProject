...
class RenewalReminderServiceImplTest {
    ...
    void setUp() {
        ...
        subscription.setRenewalReminderEnabled(true); // opt-in so reminder emails fire
    ...
    class SendUpcomingRenewalRemindersTests {
        ...
        @Test
        void sendUpcomingRenewalReminders_ReminderDisabled_SkipsEmail() {
            // Arrange — subscription is active and due but reminder is opted out
            subscription.setRenewalReminderEnabled(false);
            when(subscriptionRepository.findByNextRenewalDateBefore(any(LocalDate.class)))
                    .thenReturn(List.of(subscription));
        ...
        void sendUpcomingRenewalReminders_MultipleSubscriptions_SendsEmailForEach() {
            ...
            netflix.setRenewalReminderEnabled(true); // opt-in so reminder email fires
